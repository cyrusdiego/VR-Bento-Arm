...
public class RotationScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Twist.Rotate(Mathf.Floor(robotTwistSliderValue * twistTurnRate), 0, 0, Space.Self);
    ...
    private void OnGUI()
    {
        ...
        robotTwistSliderValue = GUI.HorizontalSlider(new Rect(25, 200, 100, 30), robotTwistSliderValue, -10.0f, 10.0f);
